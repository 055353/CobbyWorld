 ...
 * Elementor Widget Base class.
 *
 * Class Newsarc_Elementor_Widget_Base
 */
abstract class Newsarc_Elementor_Widget_Base extends Widget_Base
{
    /**
     * Post number.
     *
    ...
    /**
     * Register Newsarc_Elementor_Widget_Base widget controls.
     *
     * @access protected
     */
    ...
    public function widget_title_controls()
    {
        ...
        $this->start_controls_section(
            'section_newsarc_widget_title_manage',
            array(
                'label' => esc_html__('Block Title', 'newsarc'),
            )
        );
        // Widget title.
        $this->add_control(
            'widget_title',
            array(
                'label' => esc_html__('Title:', 'newsarc'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Add your custom block title', 'newsarc'),
                'label_block' => true,
            )
        );
    ...
    public function widget_title_style_controls()
    {
        ...
        $this->start_controls_section(
            'section_newsarc_widget_title_design_manage',
            array(
                'label' => esc_html__('Widget Title', 'newsarc'),
        ...
        $this->add_control(
            'widget_title_color',
            array(
                'label' => esc_html__('Color:', 'newsarc'),
                'type' => Controls_Manager::COLOR,
                'default' => '#2eb85d',
                'selectors' => array(
                    '{{WRAPPER}} .newsarc-element-wrapper .module-title span' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .newsarc-element-wrapper .module-title' => 'border-bottom-color: {{VALUE}}',
                ),
            )
        );
        $this->add_control(
            ...
            array(
                'label' => esc_html__('Text Color:', 'newsarc'),
                'type' => Controls_Manager::COLOR,
                'default' => '#ffffff',
                'selectors' => array(
                    '{{WRAPPER}} .newsarc-element-wrapper .module-title span' => 'color: {{VALUE}}',
                ),
            )
        );
        $this->end_controls_section();
        // Widget design section.
        $this->start_controls_section(
            'section_newsarc_widget_font_design_manage',
            array(
                'label' => esc_html__('Widget Font', 'newsarc'),
                'tab' => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_responsive_control(
            'meta_font_size',
            [
                'label' => esc_html__('Meta Font Size', 'newsarc') . ' (px)',
        ...
        $this->add_responsive_control(
            'content_font_size',
            [
                'label' => esc_html__('Content Font Size', 'newsarc') . ' (px)',
                'type' => Controls_Manager::NUMBER,
                'placeholder' => 20,
                'selectors' => [
    ...
    public function posts_controls()
    {
        ...
        $this->start_controls_section(
            'section_newsarc_posts_manage',
            array(
                'label' => esc_html__('Posts', 'newsarc'),
            )
        );
        $this->add_control(
            'posts_number',
            array(
                'label' => esc_html__('Number of posts to display:', 'newsarc'),
                'type' => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'offset_posts_number',
            array(
                'label' => esc_html__('Offset Posts:', 'newsarc'),
                'type' => Controls_Manager::TEXT,
            )
        );
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'section_newsarc_posts_category',
            array(
                'label' => esc_html__('Posts Category', 'newsarc'),
            )
        );
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Category Meta', 'newsarc'),
                'default' => 'yes',
            ]
        );
        $this->add_control(
            'category_meta_text',
            array(
                'label' => esc_html__('Category Title', 'newsarc'),
                'type' => Controls_Manager::TEXT,
                'default' => '',
            )
        );
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Category Option', 'newsarc'),
                'options' => [
                    'none' => esc_html__('None', 'newsarc'),
                    'has-background' => esc_html__('Has background', 'newsarc'),
                    'has-text-color' => esc_html__('Has text color', 'newsarc'),
                ],
        ...
        $this->add_control(
            'number_of_cat',
            array(
                'label' => esc_html__('Number of Category', 'newsarc'),
                'type' => Controls_Manager::TEXT,
                'default' => '1',
            )
        );
        $this->end_controls_section();
        $this->start_controls_section(
            'section_newsarc_posts_author',
            array(
                'label' => esc_html__('Posts Author', 'newsarc'),
            )
        );
        $this->add_control(
            'enable_author_meta',
            [
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label' => esc_html__('Author Meta', 'newsarc'),
                'default' => 'yes',
            ]
        );
        $this->add_control(
            ...
            [
                'type' => \Elementor\Controls_Manager::SELECT,
                'label' => esc_html__('Author Option', 'newsarc'),
                'options' => [
                    'with_label' => esc_html__('With Label', 'newsarc'),
                    'with_icon' => esc_html__('With Icon', 'newsarc'),
                    'with_avatar_image' => esc_html__('With Avatar Image', 'newsarc'),
                ],
                'default' => 'with_icon',
            ]
        );
        $this->add_control(
            'author_text',
            array(
                'label' => esc_html__('Author Text', 'newsarc'),
                'type' => Controls_Manager::TEXT,
                'default' => 'By',
            )
        );
        $this->end_controls_section();
        $this->start_controls_section(
            'section_newsarc_posts_date',
            array(
                'label' => esc_html__('Posts Date', 'newsarc'),
            )
        );
        $this->add_control(
            'enable_date_meta',
            [
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label' => esc_html__('Date Meta', 'newsarc'),
                'default' => 'yes',
            ]
        );
        $this->add_control(
            ...
            [
                'type' => \Elementor\Controls_Manager::SELECT,
                'label' => esc_html__('Date Format', 'newsarc'),
                'options' => [
                    'format_1' => esc_html__('Format 1', 'newsarc'),
                    'format_2' => esc_html__('Format 2', 'newsarc'),
                ],
                'default' => 'format_1',
            ]
        );
    ...
    public function posts_filter_controls()
    {
        ...
        $this->start_controls_section(
            'section_newsarc_posts_filter_manage',
            array(
                'label' => esc_html__('Filter', 'newsarc'),
            )
        );
        $this->add_control(
            'display_type',
            array(
                'label' => esc_html__('Display the posts from:', 'newsarc'),
                'type' => Controls_Manager::SELECT,
                'default' => 'latest',
                'options' => array(
                    'latest' => esc_html__('Latest Posts', 'newsarc'),
                    'categories' => esc_html__('Categories', 'newsarc'),
                ),
            )
        );
        $this->add_control(
            'categories_selected',
            array(
                'label' => esc_html__('Select categories:', 'newsarc'),
                'type' => Controls_Manager::SELECT,
                'options' => newsarc_elementor_categories(),
                'condition' => array(
