<?php
/**
 * NewsArc Elementor Widget Grid 3.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Grid 3.
 *
 * Class NewsArc_Elementor_Widgets_Grid_3
 */
class NewsArc_Elementor_Widgets_Grid_3 extends Newsarc_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_3 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Grid-3';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_3 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 3', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_3 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-grid-3';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Grid_3 widget belongs to.
     *
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Grid_3 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newsarc-module-grid newsarc-module-grid-style-3 newsarc-element-wrapper wrapper-gutter-small">
            <?php
