<?php
/**
 * NewsArc Elementor Widget Block 1.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Block 1.
 *
 * Class NewsArc_Elementor_Widgets_Block_1
 */
class NewsArc_Elementor_Widgets_Block_1 extends Newsarc_Elementor_Widget_Base
{

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_1 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Block-1';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_1 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 1', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_1 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-block-1';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Block_1 widget belongs to.
     *
    ...
    {
        return array('newsarc-widget-blocks');
    }
    ...
    public function widget_title_font_controls() {
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Font Size Left Column', 'newsarc' ) . ' (px)',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Font Size Right Column', 'newsarc' ) . ' (px)',
                'type' => Controls_Manager::NUMBER,
                'placeholder' => 20,
                'selectors' => [
                    '{{WRAPPER}} h3.elementor-entry-title.entry-title.entry-title-medium ' => 'font-size: {{VALUE}}px', //Need the full path for exclude the inner section
    ...
    public function posts_controls_excerpt() {
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Post Excerpt', 'newsarc'),
                'default' => 'yes',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Content Line Limit', 'newsarc'),
                'options' => [
                    'limit-line-1' => esc_html__( '1 Line', 'newsarc' ),
                    'limit-line-2' => esc_html__( '2 Lines', 'newsarc' ),
                    'limit-line-3' => esc_html__( '3 Lines', 'newsarc' ),
                    'limit-line-4' => esc_html__( '4 Lines', 'newsarc' ),
                    'limit-line-5' => esc_html__( '5 Lines', 'newsarc' ),
                ],
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Block_1 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newsarc-module-block newsarc-module-block-style-1 newsarc-element-wrapper wrapper-gutter-medium">
            <?php
                        ...
                        <article id="module-1-<?php the_ID(); ?>" <?php post_class('wpi-post-module-block wpi-post wpi-post-regular'); ?>>
                            ...
                            <div class="elementor-entry-details entry-details">
                                ...
                                if ($enable_category_meta === 'yes') {
                                    newsarc_post_category($display_category_option, $category_meta_text, $number_of_cat);
                                }
                                ?>
