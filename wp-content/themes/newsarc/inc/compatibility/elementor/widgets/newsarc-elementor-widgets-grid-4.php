<?php
/**
 * NewsArc Elementor Widget Grid 4.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Grid 4.
 *
 * Class NewsArc_Elementor_Widgets_Grid_4
 */
class NewsArc_Elementor_Widgets_Grid_4 extends Newsarc_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_4 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Grid-4';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_4 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 4', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_4 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-grid-4';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Grid_4 widget belongs to.
     *
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Grid_4 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newsarc-module-grid newsarc-module-grid-style-4 newsarc-element-wrapper wrapper-gutter-small">
            <?php
