<?php
/**
 * NewsArc Elementor Widget Grid 1.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Grid 1.
 *
 * Class NewsArc_Elementor_Widgets_Grid_1
 */
class NewsArc_Elementor_Widgets_Grid_1 extends Newsarc_Elementor_Widget_Base
{
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_1 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Grid-1';
    }
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_1 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 1', 'newsarc');
    }
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_1 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-grid-1';
    }
    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Grid_1 widget belongs to.
     *
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Grid_1 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        ?>
        <div class="newsarc-module-grid newsarc-module-grid-style-1 newsarc-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    $main_wrapper_class = (1 === $count) ? 'wpi-post-module-grid wpi-post wpi-tile-post newsarc-module-grid--full elementor-custom-column' : 'wpi-post-module-grid wpi-post wpi-tile-post newsarc-module-grid--quarter elementor-custom-column';
                    ?>
                    <article id="module-grid-2-<?php the_ID(); ?>" class="<?php echo esc_attr($main_wrapper_class); ?>">
