<?php
/**
 * NewsArc Elementor Widget Block 2.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Block 2.
 *
 * Class NewsArc_Elementor_Widgets_Block_2
 */
class NewsArc_Elementor_Widgets_Block_2 extends Newsarc_Elementor_Widget_Base
{
    /**
     * Post number.
     *
    ...
    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_2 widget name.
     *
     * @access public
    ...
    {
        return 'NewsArc-Posts-Block-2';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_2 widget title.
     *
     * @access public
    ...
    {
        return esc_html__('Block Style 2', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_2 widget icon.
     *
     * @access public
    ...
    {
        return 'newsarc-econs-block-2';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Block_2 widget belongs to.
     *
     * @access public
    ...
    public function widget_title_font_controls() {
        $this->add_responsive_control(
            'title_font_size',
            [
                'label' => esc_html__( 'Title Font Size', 'newsarc' ) . ' (px)',
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Block_2 widget output on the frontend.
     *
     * @access protected
     */
    protected function render()
    {
        ...
        <div class="newsarc-module-block newsarc-module-block-style-2 newsarc-element-wrapper wrapper-gutter-medium">
            <?php
