<?php
/**
 * NewsArc Elementor Widget Block 5.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Block 5.
 *
 * Class NewsArc_Elementor_Widgets_Block_5
 */
class NewsArc_Elementor_Widgets_Block_5 extends Newsarc_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_5 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Block-5';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_5 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 5', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Block_5 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-block-5';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Block_5 widget belongs to.
     *
    ...
    /**
     * Render NewsArc_Elementor_Widgets_Block_5 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newsarc-module-block newsarc-module-block-style-5 newsarc-element-wrapper wrapper-gutter-medium">
            <?php
