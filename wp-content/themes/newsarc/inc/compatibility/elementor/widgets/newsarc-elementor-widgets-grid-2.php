<?php
/**
 * NewsArc Elementor Widget Grid 2.
 *
 * @package    NewsArc
 * @since      NewsArc 1.0.0
 */
 ...
 * NewsArc Elementor Widget Grid 2.
 *
 * Class NewsArc_Elementor_Widgets_Grid_2
 */
class NewsArc_Elementor_Widgets_Grid_2 extends Newsarc_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_2 widget name.
     *
     * @access public
     *
    ...
    {
        return 'NewsArc-Posts-Grid-2';
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_2 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 2', 'newsarc');
    }

    /**
     * Retrieve NewsArc_Elementor_Widgets_Grid_2 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'newsarc-econs-grid-2';
    }

    /**
     * Retrieve the list of categories the NewsArc_Elementor_Widgets_Grid_2 widget belongs to.
     *
    ...
    {
        return array('newsarc-widget-grid');
    }

    /**
     * Render NewsArc_Elementor_Widgets_Grid_2 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="newsarc-module-grid newsarc-module-grid-style-2 newsarc-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    $main_div_loop_wrapper_class = 'wpi-post-module-grid wpi-post wpi-tile-post newsarc-module-grid--half elementor-custom-column';
                    ...
                    if (1 == $count) {
                        ...
                        $main_div_loop_wrapper_class = 'wpi-post-module-grid wpi-post wpi-tile-post newsarc-module-grid--full elementor-custom-column';
                    }
                    ...
                    <article id="module-grid-2-<?php the_ID(); ?>" class="<?php echo esc_attr($main_div_loop_wrapper_class); ?>">
