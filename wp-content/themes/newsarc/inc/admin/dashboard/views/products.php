<div class="newsarc-dashboard-content products-page">
    <div class="dashboard-content-panel">
        <div class="postbox newsarc-quick-settings">
            <div class="postbox-header">
            <h2 class="hndle ui-sortable-handle">
                <?php esc_html_e('Themes', 'newsarc'); ?>
            </h2>
            </div>
            <div class="inside inside__themes">
                ...
                $themes_data = array(
                    'newsmarks' => array(
                        'name' => 'NewsMarks',
                        'slug' => 'newsmarks',
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/newsmarks.webp',
                    ...
                    'newsmass' => array(
                        'name' => 'NewsMass',
                        'slug' => 'newsmass',
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/newsmass.webp',
                    ...
                    'blogmarks' => array(
                        'name' => 'BlogMarks',
                        'slug' => 'blogmarks',
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/blogmarks.webp',
                        ...
                        <div class="cta">
                            <div class="cta-text">
                                <a href="<?php echo esc_url($theme_info['learn_more_link']); ?>"
                                   target="_blank"><?php esc_html_e('Learn More', 'newsarc'); ?></a>
                                <a href="<?php echo esc_url($theme_info['live_demo_link']); ?>"
                                   target="_blank"><?php esc_html_e('Live demo', 'newsarc'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="postbox newsarc-quick-settings">
            <div class="postbox-header">
            <h2 class="hndle ui-sortable-handle">
                <?php esc_html_e('Plugins', 'newsarc'); ?>
            </h2>
            </div>
            <div class="inside inside__plugins">
                ...
                $plugins_data = array(
                    ...
                    'elementor' => array(
                        ...
                        'slug' => 'elementor',
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/elementor-banner.webp',
                    ...
                    'one-click-demo-import' => array(
                        ...
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/ocdi.webp',
                    ...
                    'mailchimp-for-wp' => array(
                        ...
                        'image' => NEWSARC_PARENT_URL . '/inc/admin/dashboard/images/mc4wp.webp',
                        ...
                        <div class="cta">
                            <div class="cta-text">
                                ...
                                <a href="<?php echo $plugin_info['live_demo_link']; ?>"
                                   target="_blank"><?php esc_html_e('Plugin Page', 'newsarc'); ?></a>
                            </div>
                            <div class="cta-button">
                                <?php if ($is_plugin_installed) : ?>
                                    <?php if ($is_plugin_activated) : ?>
                                        <span class="activated"><?php esc_html_e('Activated', 'newsarc'); ?></span>
                                    <?php else : ?>
                                        <a href="#" class="button button-primary dashboard-button dashboard-button-primary activate-plugin" data-plugin="<?php echo $plugin_file; ?>" data-slug="<?php echo $plugin_slug; ?> "><?php esc_html_e('Activate', 'newsarc'); ?></a>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <a href="#" class="button button-secondary dashboard-button dashboard-button-secondary install-plugin" data-plugin="<?php echo $plugin_file; ?>" data-slug="<?php echo $plugin_slug; ?> "><?php esc_html_e('Install', 'newsarc'); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
