...
?>
<div class="newsarc-dashboard-content free-vs-pro-page">
    <table class="newsarc-compare-table">
        <tbody>
        <?php
        ...
        $features = array(
            ...
            'TG Widgets' => array(
                'showFreePro' => true,
                'items' => array(
                    array('NewsArc: Advertisement Widget', $cross_mark, $tick_mark),
                    array('NewsArc: Instagram Widget', $cross_mark, $tick_mark),
                    array('NewsArc: Author Widget', $tick_mark, $tick_mark),
                    array('NewsArc: CTA', $tick_mark, $tick_mark),
                    array('NewsArc: Carousel Posts', $tick_mark, $tick_mark),
                    array('NewsArc: Categories', $tick_mark, $tick_mark),
                    array('NewsArc: Grid Posts', $tick_mark, $tick_mark),
                    array('NewsArc: Image Widget', $tick_mark, $tick_mark),
                    array('NewsArc: Mailchimp', $tick_mark, $tick_mark),
                    array('NewsArc: Metro Post', $tick_mark, $tick_mark),
                    array('NewsArc: Recent Posts', $tick_mark, $tick_mark),
                    array('NewsArc: Currency Exchange', $cross_mark, $tick_mark),
                    array('NewsArc: Google Maps', $cross_mark, $tick_mark),
                    array('NewsArc: Weather', $cross_mark, $tick_mark),
                    array('NewsArc: Slider Posts', $tick_mark, $tick_mark),
                    array('NewsArc: Social Menu', $tick_mark, $tick_mark),
                    array('NewsArc: Tab Posts', $tick_mark, $tick_mark),
                    array('NewsArc: Youtube Video', $tick_mark, $tick_mark),
                ),
            ),
        ...
        foreach ($features as $category => $feature) :
            ...
            <tr class="compare-table-head">
                ...
                <?php if ($show_free_pro) : ?>
                    <td><?php esc_html_e('Free', 'newsarc'); ?></td>
                    <td><?php esc_html_e('Pro', 'newsarc'); ?></td>
                <?php endif; ?>
            </tr>
    ...
    <div class="postbox newsarc-postbox-upsell">
        <div class="icon">
        ...
        <h3><?php esc_html_e('Upgrade Now', 'newsarc'); ?></h3>
        <p><?php echo __('Access all premium extensions, features, and upcoming updates right away by <br> upgrading to the Pro version.', 'newsarc'); ?></p>
        <a href="<?php echo esc_url($this->theme_url); ?>#choose-pricing-plan" class="button button-secondary dashboard-button dashboard-button-primary" target="_blank">
            <?php esc_html_e('Get NewsArc Pro Now', 'newsarc'); ?>
        </a>
    </div>
</div>
