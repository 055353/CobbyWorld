...
class Newsarc_Image_Widget extends Newsarc_Widget_Base
{
    /**
     * Constructor.
     */
    ...
    {
        $this->widget_cssclass = 'newsarc-image-widget';
        $this->widget_description = __("The Image Widget offers versatile design with two style variations. Effortlessly incorporate images, titles, descriptions, and links for dynamic and engaging content presentation in a single widget.", 'newsarc');
        $this->widget_id = 'newsarc_image_widget';
        $this->widget_name = __('NewsArc: Image Widget', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'title_text' => array(
                'type' => 'text',
                'label' => __('Widget Description', 'newsarc'),
            ),
            'bg_image' => array(
                'type' => 'image',
            ...
            'btn_text' => array(
                'type' => 'text',
                'label' => __('Button Text', 'newsarc'),
            ),
            'btn_link' => array(
                'type' => 'url',
                'label' => __('Link to URL', 'newsarc'),
                'desc' => __('Please make sure to provide a complete URL that includes either "http://" or "https://" to ensure the widget operates correctly.', 'newsarc'),
            ),
            'link_target' => array(
                'type' => 'checkbox',
                'label' => __('Open Link in new Tab', 'newsarc'),
                'std' => true,
            ),
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_image');
        ?>
