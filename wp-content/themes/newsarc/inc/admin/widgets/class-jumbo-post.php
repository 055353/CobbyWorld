...
class Newsarc_Jumbo_Widget extends Newsarc_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'newsarc-widget-jumbo-post';
        $this->widget_description = __("Jumbo Widget transforms your posts into a visually appealing mosaic, creating a stylish and organized showcase for an immersive reader experience.", 'newsarc');
        $this->widget_id = 'Newsarc_Jumbo_Widget';
        $this->widget_name = __('NewsArc: Jumbo Post', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'layout_style' => array(
                'type' => 'select',
                'label' => __('Style Layout', 'newsarc'),
                'options' => array(
                    'jumbo-layout-1' => __('Layout 1', 'newsarc'),
                    'jumbo-layout-2' => __('Layout 2', 'newsarc'),
                    'jumbo-layout-3' => __('Layout 3', 'newsarc'),
                ),
                'std' => 'jumbo-layout-1',
            ),
            'offset' => array(
            ...
            'category' => array(
                ...
                'desc' => __('Leave empty if you don\'t want the posts to be category specific', 'newsarc'),
                'args' => array(
                    'taxonomy' => 'category',
                    'class' => 'widefat',
                    'hierarchical' => true,
    ...
    public function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('Newsarc_Jumbo_Widget_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_jumbo_widget');
        $counter = 1;
                ...
                case "jumbo-layout-1": ?>
                    <div class="wpi-jumbo-widget">
                        ...
                        while ($posts->have_posts()): $posts->the_post();
                            ...
                            $image_class = ($counter == 1) ? "entry-image-large" : (($counter == 2 || $counter == 3) ? "entry-image-medium" : "");
                            $title_class = ($counter == 1) ? "entry-title-big" : "entry-title-small";
                            // Determine if we need to open or close the right container
                            if ($counter == 1) echo '<div class="jumbo-widget-left border-lg-r">';
                                        ...
                                        <?php if (!empty($instance['show_date']) && $instance['show_date']) : ?>
                                            <div class="entry-meta entry-date posted-on">
                                                ...
                                                echo ('format_1' === $date_format) ?
                                                    esc_html(human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . __('ago', 'newsarc')) :
        ...
        do_action('newsarc_after_jumbo_widget');
        ob_end_flush();
    }
}