...
class Newsarc_CTA extends Newsarc_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'widget_newsarc_cat';
        $this->widget_description = __("Displays call to action button and text with background", 'newsarc');
        $this->widget_id = 'newsarc_cat';
        $this->widget_name = __('NewsArc: CTA', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'description' => array(
                'type' => 'textarea',
                'label' => __('CTA Description', 'newsarc'),
                'rows' => 10,
            ),
            'button_text_1' => array(
                'type' => 'text',
                'label' => __('Button Text - 1', 'newsarc'),
            ),
            'button_link_1' => array(
                'type' => 'url',
                'label' => __('Link to url - 1', 'newsarc'),
                'desc' => __('Enter a proper url with http: OR https:', 'newsarc'),
            ),
            'link_target_1' => array(
                'type' => 'checkbox',
                'label' => __('Open Link in new Tab - 1', 'newsarc'),
                'std' => true,
            ),
            'button_text_2' => array(
                'type' => 'text',
                'label' => __('Button Text - 2', 'newsarc'),
            ),
            'button_link_2' => array(
                'type' => 'url',
                'label' => __('Link to url - 2', 'newsarc'),
                'desc' => __('Enter a proper url with http: OR https:', 'newsarc'),
            ),
            'link_target_2' => array(
                'type' => 'checkbox',
                'label' => __('Open Link in new Tab - 2', 'newsarc'),
                'std' => true,
            ),
