...
class Newsarc_Metro_Post_Widget extends Newsarc_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'newsarc-widget-metro-post';
        $this->widget_description = __("Metro Widget transforms your posts into a visually appealing mosaic, creating a stylish and organized showcase for an immersive reader experience.", 'newsarc');
        $this->widget_id = 'Newsarc_Metro_Post_Widget';
        $this->widget_name = __('NewsArc: Metro Post', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'layout_style' => array(
                ...
                'options' => array(
                    'metro-layout-1' => __('Layout 1', 'newsarc'),
                    'metro-layout-2' => __('Layout 2', 'newsarc'),
                    'metro-layout-3' => __('Layout 3', 'newsarc'),
                    'metro-layout-4' => __('Layout 4', 'newsarc'),
                    'metro-layout-5' => __('Layout 5', 'newsarc'),
                ),
                'std' => 'metro-layout-1',
            ),
            'offset' => array(
    ...
    public function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('Newsarc_Metro_Post_Widget_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_metro_widget');
        $counter = 1;
        ...
        do_action('newsarc_after_metro_widget');
