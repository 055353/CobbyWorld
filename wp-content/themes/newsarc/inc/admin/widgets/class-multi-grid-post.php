...
class Newsarc_Multi_Grid_Post extends Newsarc_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'newsarc-multi-grid-post';
        $this->widget_description = __("Shows post in multi grid layout", 'newsarc');
        $this->widget_id = 'Newsarc_Multi_Grid_Post';
        $this->widget_name = __('NewsArc: Multi Grid Post', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'title_size_1' => array(
                'type' => 'select',
                'label' => __('Font size for Prime Article', 'newsarc'),
                'options' => array(
            ...
            'title_size_2' => array(
                'type' => 'select',
                'label' => __('Font size for Sub Articles', 'newsarc'),
                'options' => array(
                    'entry-title-medium' => __('Medium', 'newsarc'),
                    'entry-title-small' => __('Small', 'newsarc'),
                ),
            ...
            'show_description' => array(
                'type' => 'checkbox',
                'label' => __('Show Description', 'newsarc'),
                'std' => true,
            ),
            'category' => array(
    ...
    public function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('Newsarc_Multi_Grid_Post_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (($posts = $this->get_posts($args, $instance)) && $posts->have_posts()) {
            ...
            do_action('newsarc_before_simplepost_widget');
            ?>
            ...
            <?php
            do_action('newsarc_after_simplepost_widget');
