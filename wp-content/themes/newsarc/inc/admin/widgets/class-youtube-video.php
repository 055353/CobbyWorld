...
class Newsarc_Youtube_Video extends Newsarc_Widget_Base
{
    /**
     * Constructor.
     */
    public function __construct()
    {
        ...
        $this->widget_cssclass = 'newsarc_youtube_video';
        $this->widget_description = __('Displays youtube video form your channel.', 'newsarc');
        $this->widget_id = 'newsarc_youtube_video';
        $this->widget_name = __('NewsArc: Youtube Video', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'channel_name' => array(
                'type' => 'text',
                'label' => __('Channel Name:', 'newsarc'),
            ),
            'video_url' => array(
                'type' => 'url',
                'label' => __('Video URL:', 'newsarc'),
                'desc' => __('Please make sure to provide a complete URL that includes either "http://" or "https://" to ensure the widget operates correctly.', 'newsarc'),
    ...
    public function widget($args, $instance)
    {
        ...
        <div class="site-youtube-widget">
            ...
            <a class="site-youtube-subscribe" href="<?php echo esc_url($channel_url); ?>" target="_blank"><?php esc_html_e('Subscribe', 'newsarc'); ?></a>
