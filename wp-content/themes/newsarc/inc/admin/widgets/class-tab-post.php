...
class Newsarc_Tab_Post extends Newsarc_Widget_Base
{
    ...
    {
        $this->widget_cssclass = 'newsarc-tabbed-widget';
        $this->widget_description = __('Displays posts in tab', 'newsarc');
        $this->widget_id = 'newsarc_tab_posts';
        $this->widget_name = __('NewsArc: Tab Posts', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            'popular_post_settings' => array(
                'type' => 'heading',
                'label' => __('Popular Post Settings', 'newsarc'),
            ),
            'show_popular_posts' => array(
                'type' => 'checkbox',
                'label' => __('Show Tab', 'newsarc'),
                'std' => true,
            ),
            'popular_post_desc' => array(
                'type' => 'subtitle',
                'label' => __('Will display post based on comments count', 'newsarc'),
            ),
            'popular_posts_title' => array(
                'type' => 'text',
                'label' => __('Title', 'newsarc'),
                'std' => __('Popular', 'newsarc'),
                'desc' => __('Leave as it is to show default title or leave blank to only show icon', 'newsarc'),
            ),
            ...
            'popular_post_offset' => array(
                ...
                'desc' => __('Can be useful if you want to skip certain number of posts. Leave as 0 if you do not want to use it.', 'newsarc'),
            ),
            ...
            'hot_post_settings' => array(
                'type' => 'heading',
                'label' => __('Hot Post Settings', 'newsarc'),
            ),
            ...
            'latest_post_settings' => array(
                'type' => 'heading',
                'label' => __('Latest Post Settings', 'newsarc'),
            ),
            ...
            'general_settings' => array(
                'type' => 'heading',
                'label' => __('General Settings', 'newsarc'),
            ),
            'number' => array(
                'type' => 'number',
                'step' => 1,
            ...
            'date_format' => array(
                ...
                'desc' => __('Make sure to select Date from above for this to work.', 'newsarc'),
                'options' => array(
                    'format_1' => __('Times Ago', 'newsarc'),
                    'format_2' => __('Default Format', 'newsarc'),
                ),
                'std' => 'format_1',
            ),
            'show_category' => array(
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_tab_posts');
        ++self::$counter;
        $this->unique_id = 'newsarc-tab-' . self::$counter;
        ?>
        <div class="wpi-tabbed-widget">
            <ul class="tabbed-widget-header reset-list-style" role="tablist"
                aria-label="<?php esc_attr_e('Tab Navigation', 'newsarc'); ?>">
        ...
        <?php
        do_action('newsarc_after_tab_posts');
