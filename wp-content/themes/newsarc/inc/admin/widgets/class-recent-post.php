...
class Newsarc_Recent_Posts extends Newsarc_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'newsarc-recent-widget';
        $this->widget_description = __("Displays recent posts with an image", 'newsarc');
        $this->widget_id = 'newsarc_recent_posts';
        $this->widget_name = __('NewsArc: Recent Posts', 'newsarc');
        ...
        return array(
            ...
            'style' => array(
                ...
                'options' => array(
                    ...
                    'wpi-post-list' => __('List View', 'newsarc'),
                    'wpi-post-card' => __('Card View', 'newsarc'),
                ),
                'std' => 'wpi-post-list',
            ),
            'font_size' => array(
            ...
            'show_counter' => array(
                'type' => 'checkbox',
                'label' => __('Show Counter', 'newsarc'),
                'std' => true,
            ),
            'show_image' => array(
                'type' => 'checkbox',
                'label' => __('Show Image', 'newsarc'),
                'std' => true,
            ),
            'image_size' => array(
                'type' => 'select',
                ...
                'options' => array(
                    'thumbnail' => __('Thumbnail', 'newsarc'),
    ...
    protected function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('newsarc_recent_posts_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_recent_posts_with_image');
        ...
        do_action('newsarc_after_recent_posts_with_image');
