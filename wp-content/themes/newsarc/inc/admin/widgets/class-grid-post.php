...
class Newsarc_Grid_Post extends Newsarc_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'widget_newsarc_grid_posts';
        $this->widget_description = __("Displays grid posts with an image", 'newsarc');
        $this->widget_id = 'newsarc_grid_posts';
        $this->widget_name = __('NewsArc: Grid Posts', 'newsarc');
    ...
    protected function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('newsarc_grid_posts_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_grid_posts_with_image');
        ...
        do_action('newsarc_after_grid_posts_with_image');
