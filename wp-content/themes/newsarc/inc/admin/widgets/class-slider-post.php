...
class Newsarc_Slider_Posts extends Newsarc_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'newsarc-slider-widget';
        $this->widget_description = __("Displays recent posts in a slider with an image", 'newsarc');
        $this->widget_id = 'newsarc_slider_posts';
        $this->widget_name = __('NewsArc: Slider Posts', 'newsarc');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'number' => array(
                ...
                'min' => 1,
                'std' => 5,
                'label' => __('Number of posts to show', 'newsarc'),
            ),
            'offset' => array(
                'type' => 'number',
                'step' => 1,
    ...
    protected function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('newsarc_slider_posts_query_args', $query_args));
    }
    /**
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('newsarc_before_slider_posts_with_image');
        ...
        <?php
        do_action('newsarc_after_slider_posts_with_image');
