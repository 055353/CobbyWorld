 ...
 * @extends WP_Widget
 */
abstract class Newsarc_Widget_Base extends WP_Widget {
    ...
    public function __construct() {
        ...
        add_action( 'admin_enqueue_scripts', array( $this, 'newsarc_widget_scripts' ) );
    }
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        foreach ( $this->settings as $key => $setting ) {
             ...
             */
            $instance[ $key ] = apply_filters( 'newsarc_widget_settings_sanitize', $instance[ $key ], $new_instance, $key, $setting );
        }
     ...
     * @return void
     */
    public function newsarc_widget_scripts( $hook ) {
    	if ( 'widgets.php' === $hook ) {
    		...
    		wp_enqueue_media();
    		wp_enqueue_style( 'newsarc_widgets_css', get_template_directory_uri() . '/inc/admin/widgets/assets/css/style.css' );
    		wp_enqueue_script( 'newsarc_widgets_js', get_template_directory_uri() . '/inc/admin/widgets/assets/js/script.js', array( 'jquery', 'wp-color-picker' ), NEWSARC_VERSION, true );
    	}
    }
}
