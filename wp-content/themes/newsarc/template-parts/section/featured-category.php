<?php 
$enable_featured_category = newsarc_get_option('enable_featured_category');
$featured_category_title = newsarc_get_option('featured_category_title');
?>
...
<section class="wpi-section wpi-categories-section">
    <div class="wrapper">
        ...
        <div class="wpi-section-content categories-section-content">
            <?php for ($i=1; $i <= 4 ; $i++) { 
            $featured_category = newsarc_get_option('featured_category_'.$i);
            ...
            <div class="wpi-category-panel">
                ...
                <div class="entry-category-details category-details-vertical">
                    ...
                    <span class="entry-category-count"><?php echo absint($post_count); echo __(' Articles','newsarc');?> </span>
                ...
                $category_post->the_post(); ?>
                    <div class="entry-category-details category-details-horizontal">
                        <span class="entry-category-label"> <?php echo __('Latest:','newsarc');?> </span>
